...
class CheckoutReservationCard extends StatefulWidget {
  ...
  CheckoutReservationCard({Key key, this.reservation}) : super(key: key);
                  ...
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Text(
                          "Starting date : " +
                              format.format(widget.reservation.startingDate),
                          style: TextStyle(
                            fontSize: 11,
                ...
                Row(
                  ...
                  children: [
                    RoundedButton(
                      ...
                      press: () {
                       ApiManager.resarvationdelete(widget.reservation.Id).then((value){
                            Navigator.push(
                          context,
                          MaterialPageRoute(
                    ...
                    RoundedButton(
                      ...
                      textColor: Colors.white,
                      press: () {
                        ApiManager.resarvationUpdate(widget.reservation.Id).then((value){
                            Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => ParkingLayout()),
