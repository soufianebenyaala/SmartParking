...
class ApiManager {
  ...
  static Future<String> addCar(String number, String type, String description) async {
    try {
  ...
  static Future<String> carUpdate(String number, String description, String type,String id) async {
    try {
      final uri = Uri.parse(ApiManager.carAPIURL+"/"+id);
      final headers = {'Content-Type': 'application/json'};
  ...
  static Future<String> createReclamation( name, email, address, description,status) async {
try {
